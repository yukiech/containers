...
namespace ft
{
	template <class InputIterator> typename ft::iterator_traits<InputIterator>::difference_type distance(InputIterator first, InputIterator last)
	{
	...
	template <class Iterator> class reverse_iterator
	{
		...
		public:
			...
			explicit reverse_iterator ( Iterator const & it) : _current(it)
			{
			}
